...
Dirs.add_argument("--output_cache_fn",type=str,default=f"{base_dir}/data/YOHO_PN",
                        help="eval cache dir")
...
Dataset_Args.add_argument("--train_pcpair_list_fn",type=str,default=f'{base_dir}/data/YOHO_PN/train.pkl',
...
Train_Args.add_argument("--loss_type",type=str,default="L2_loss_partII",
                        help="loss type")                        
Train_Args.add_argument("--epochs",type=int,default=6,
                        help="num of epoches")
...
#Validation Args
Dataset_Args.add_argument("--val_pppair_list_fn",type=str,default=f'{base_dir}/data/YOHO_PN/val.pkl',
                        help="validation tuples (station,pc0,pc1,R_i,R_j,pt0,pt1)")
Val_Args.add_argument("--val_interval",type=int,default=2000,
...
Pipeline.add_argument('--extractor',type=str,default='PartII',
                        help="name of extractor")
Pipeline.add_argument('--matcher',type=str,default='Match_pca',
...
#Input
Test_Args.add_argument('--Part',default='PartII',type=str,help='Input PartI or PartII')
Test_Args.add_argument('--max_iter',default=1000,type=int,help='Input ransac iterations')
Test_Args.add_argument('--dataset',default='ETH',type=str,help='Input dataset name')
