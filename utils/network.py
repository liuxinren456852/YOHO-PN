...
class PartII_train(nn.Module):
    def __init__(self, cfg):
        ...
        self.Conv_init=Comb_Conv(32*4,128)
        self.PartII_SO3_Conv_layers=nn.ModuleList([Residual_Comb_Conv(128,128,128,self.Nei_in_SO3)])
        
        self.PartII_To_R_dims=[128,64,32,4]
